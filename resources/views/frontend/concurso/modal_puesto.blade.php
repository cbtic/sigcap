		...
		<div class="card">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding-top:10px">
					...
					<div class="row">
						...
						-->
						<div class="col-lg-2 col-md-12 col-sm-12 col-xs-12">
							<label class="control-label">Tipo Puesto</label>
						</div>
						<div class="col-lg-7 col-md-12 col-sm-12 col-xs-12">
							<select name="id_tipo_plaza" id="id_tipo_plaza" class="form-control form-control-sm" onChange="">
								<option value="">--Selecionar--</option>
								<?php
								foreach ($tipo_plaza as $row) {?>
								<option value="<?php echo $row->codigo?>" <?php //if($row->codigo==$concurso_puesto->id_tipo_plaza)echo "selected='selected'"?>><?php echo $row->denominacion?></option>
								<?php 
								}
								?>
							</select>
					...
					<div class="row" style="padding-top:10px">
						...
						<div class="col-lg-2 col-md-12 col-sm-12 col-xs-12">
							<label class="control-label">Numero Plazas</label>
						</div>
						<div class="col-lg-2 col-md-12 col-sm-12 col-xs-12">
							<input id="numero_plazas" name="numero_plazas" class="form-control form-control-sm"  value="<?php //echo $concurso_puesto->numero_plazas?>" type="text"  >
						</div>
