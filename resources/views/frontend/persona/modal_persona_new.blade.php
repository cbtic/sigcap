								...
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group" style="padding-top:0px;padding-bottom:0px;margin-top:0px;margin-bottom:0px">
											...
											<input id="numero_documento" name="numero_documento" class="form-control form-control-sm" onblur="validaDni()" value="<?php echo $numero_documento ?>" type="text" >
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group" style="padding-top:0px;padding-bottom:0px;margin-top:0px;margin-bottom:0px">
											...
											<input id="apellido_paterno" name="apellido_paterno" class="form-control form-control-sm" value="" type="text" readonly>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group" style="padding-top:0px;padding-bottom:0px;margin-top:0px;margin-bottom:0px">
											...
											<input id="apellido_materno" name="apellido_materno" class="form-control form-control-sm" value="" type="text" readonly>
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group" style="padding-top:0px;padding-bottom:0px;margin-top:0px;margin-bottom:0px">
											...
											<input id="nombres" name="nombres" class="form-control form-control-sm" value="" type="text" readonly>
										</div>
									</div>
								</div>
