...
function fn_save_empresa(){
    ...
    $.ajax({
            ...
            type: "POST",
            data : {_token:_token,id:id,ruc:ruc,nombre_comercial:nombre_comercial,razon_social:razon_social,direccion:direccion,representante:representante,estado:estado},
            success: function (result) {
					...
					<div class="row" style="padding-left:10px">
						...
						<div class="col-lg-12">
							<div class="form-group">
								...
								<textarea type="text" name="ruc" id="ruc" rows="2"
								value="<?php echo $empresas->ruc?>" placeholder="" class="form-control form-control-sm col-lg-12" >
						...
						<div class="col-lg-12">
							<div class="form-group">
								...
								<textarea type="text" name="nombre_comercial" id="nombre_comercial" rows="2"
								value="<?php echo $empresas->nombre_comercial?>" placeholder="" class="form-control form-control-sm col-lg-12" >
						...
						<div class="col-lg-12">
							<div class="form-group">
								...
								<textarea type="text" name="razon_social" id="razon_social" rows="2"
								value="<?php echo $empresas->razon_social?>" placeholder="" class="form-control form-control-sm col-lg-12" >
						...
						<div class="col-lg-12">
							<div class="form-group">
								...
								<textarea type="text" name="direccion" id="direccion" rows="2"
								value="<?php echo $empresas->direccion?>" placeholder="" class="form-control form-control-sm col-lg-12" >
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								value="<?php echo $empresas->representante?>" placeholder="" class="form-control form-control-sm col-lg-12" >
							</div>
						</div>
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								value="<?php echo $empresas->estado?>" placeholder="" class="form-control form-control-sm col-lg-12" >
							</div>
						</div>
