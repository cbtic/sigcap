...
function fn_save_traslado(){
    ...
    $.ajax({
            ...
            type: "POST",
            data : {_token:_token,id:id,id_agremiado:id_agremiado,id_region:id_region,fecha_inicio:fecha_inicio,fecha_fin:fecha_fin,numero_regional:numero_regional,observacion:observacion},
					...
					<div class="row" style="padding-left:10px">
						...
						<div class="col-lg-12">
							<div class="form-group">
								...
								<select name="id_region" id="id_region" class="form-control form-control-sm" onchange="">
									...
									<option value="<?php echo $row->id?>" <?php if($row->id==$agremiadoTraslado->id_region)echo "selected='selected'"?>><?php echo $row->denominacion?></option>
									<?php 
									}
									?>
								</select>
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								value="<?php if($agremiadoTraslado->fecha_inicio!="")echo date("d-m-Y", strtotime($agremiadoTraslado->fecha_inicio))?>" placeholder="" class="form-control form-control-sm col-lg-12" >
							</div>
						</div>
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								value="<?php if($agremiadoTraslado->fecha_fin!="")echo date("d-m-Y", strtotime($agremiadoTraslado->fecha_fin))?>" placeholder="" class="form-control form-control-sm col-lg-12" >
							</div>
						</div>
						
						<div class="col-lg-6">
							<div class="form-group">
								<label class="control-label form-control-sm">N&uacute;mero Regional</label>
								<input type="text" name="numero_regional" id="numero_regional"
								value="<?php echo $agremiadoTraslado->numero_regional?>" placeholder="" class="form-control form-control-sm col-lg-12" >
							</div>
						</div>
						...
						<div class="col-lg-12">
							<div class="form-group">
								...
								<textarea type="text" name="observacion" id="observacion" rows="2"
								placeholder="" class="form-control form-control-sm"><?php echo $agremiadoTraslado->observacion?></textarea>
					...
					<div style="margin-top:15px" class="form-group">
						<div class="col-sm-12 controls">
							<div class="btn-group btn-group-sm float-right" role="group" aria-label="Log Viewer Actions">
								<a href="javascript:void(0)" onClick="fn_save_traslado()" class="btn btn-sm btn-success">Guardar</a>
							</div>
