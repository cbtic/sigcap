					...
					<div class="row" style="padding-left:10px">
						...
						<div class="col-lg-12">
							<div class="form-group">
								<label class="control-label form-control-sm">Universidad</label>
								<select name="id_universidad" id="id_universidad" class="form-control form-control-sm" onChange="">
									<option value="">--Seleccionar--</option>
									<?php
									foreach ($universidad as $row) {?>
									<option value="<?php echo $row->codigo?>" <?php if($row->codigo==$agremiadoEstudio->id_universidad)echo "selected='selected'"?>><?php echo $row->denominacion?></option>
									<?php 
									}
									?>
								</select>
						...
						<div class="col-lg-12">
							<div class="form-group">
								<label class="control-label form-control-sm">Especialidad</label>
								<select name="id_especialidad" id="id_especialidad" class="form-control form-control-sm" onChange="">
									<option value="">--Seleccionar--</option>
									<?php
									foreach ($especialidad as $row) {?>
									<option value="<?php echo $row->codigo?>" <?php if($row->codigo==$agremiadoEstudio->id_especialidad)echo "selected='selected'"?>><?php echo $row->denominacion?></option>
									<?php 
									}
									?>
								</select>
						...
						<div class="col-lg-12">
							<div class="form-group">
								<label class="control-label form-control-sm">Tesis</label>
								<textarea type="text" name="tesis" id="tesis" rows="2"
								placeholder="" class="form-control form-control-sm"><?php echo $agremiadoEstudio->tesis?></textarea>
						...
						<div class="col-lg-6">
							<div class="form-group">
								<label class="control-label form-control-sm">Fecha Egresado</label>
								<input type="text" name="fecha_egresado" id="fecha_egresado"
								value="<?php if($agremiadoEstudio->fecha_egresado!="")echo date("d-m-Y", strtotime($agremiadoEstudio->fecha_egresado))?>" placeholder="" class="form-control form-control-sm col-lg-12" >
							</div>
						</div>
						
						<div class="col-lg-6">
							<div class="form-group">
								<label class="control-label form-control-sm">Fecha Graduado</label>
								<input type="text" name="fecha_graduado" id="fecha_graduado"
								value="<?php if($agremiadoEstudio->fecha_graduado!="")echo date("d-m-Y", strtotime($agremiadoEstudio->fecha_graduado))?>" placeholder="" class="form-control form-control-sm col-lg-12" >
							</div>
						</div>
						
						<div class="col-lg-6">
							<div class="form-group">
								<label class="control-label form-control-sm">Libro</label>
								<input type="text" name="libro" id="libro"
								value="<?php echo $agremiadoEstudio->libro?>" placeholder="" class="form-control form-control-sm col-lg-12" >
							</div>
						</div>
						
						<div class="col-lg-6">
							<div class="form-group">
								<label class="control-label form-control-sm">Folio</label>
								<input type="text" name="folio" id="folio"
								value="<?php echo $agremiadoEstudio->folio?>" placeholder="" class="form-control form-control-sm col-lg-12" >
							</div>
						</div>
					...
					<div style="margin-top:15px" class="form-group">
						<div class="col-sm-12 controls">
							<div class="btn-group btn-group-sm float-right" role="group" aria-label="Log Viewer Actions">
								<a href="javascript:void(0)" onClick="fn_save_estudio()" class="btn btn-sm btn-success">Guardar</a>
							</div>
