...
function fn_save_idioma(){
    ...
    $.ajax({
            ...
            type: "POST",
            data : {_token:_token,id:id,id_agremiado:id_agremiado,id_idioma:id_idioma,id_grado_conocimiento:id_grado_conocimiento},
					...
					<div class="row" style="padding-left:10px">
						...
						<div class="col-lg-12">
							<div class="form-group">
								<label class="control-label form-control-sm">Idioma</label>
								<select name="id_idioma" id="id_idioma" class="form-control form-control-sm" onChange="">
									<option value="">--Seleccionar--</option>
									<?php
									foreach ($idioma as $row) {?>
									<option value="<?php echo $row->codigo?>" <?php if($row->codigo==$agremiadoIdioma->id_idioma)echo "selected='selected'"?>><?php echo $row->denominacion?></option>
									<?php 
									}
									?>
								</select>
						...
						<div class="col-lg-12">
							<div class="form-group">
								<label class="control-label form-control-sm">Grado Conocimiento</label>
								<select name="id_grado_conocimiento" id="id_grado_conocimiento" class="form-control form-control-sm" onChange="">
									<option value="">--Seleccionar--</option>
									<?php
									foreach ($grado as $row) {?>
									<option value="<?php echo $row->codigo?>" <?php if($row->codigo==$agremiadoIdioma->id_grado_conocimiento)echo "selected='selected'"?>><?php echo $row->denominacion?></option>
									<?php 
									}
									?>
								</select>
					...
					<div style="margin-top:15px" class="form-group">
						<div class="col-sm-12 controls">
							<div class="btn-group btn-group-sm float-right" role="group" aria-label="Log Viewer Actions">
								<a href="javascript:void(0)" onClick="fn_save_idioma()" class="btn btn-sm btn-success">Guardar</a>
							</div>
