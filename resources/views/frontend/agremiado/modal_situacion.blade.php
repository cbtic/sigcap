					...
					<div class="row" style="padding-left:10px">
						...
						<div class="col-lg-12">
							<div class="form-group">
								<label class="control-label form-control-sm">Pa&iacute;s Destino</label>
								<select name="id_pais_destino" id="id_pais_destino" class="form-control form-control-sm" onChange="">
									<option value="">--Selecionar--</option>
									<?php
									foreach ($pais as $row) {?>
									<option value="<?php echo $row->codigo?>" <?php if($row->codigo==$agremiadoSituacion->id_pais_destino)echo "selected='selected'"?>><?php echo $row->denominacion?></option>
									<?php 
									}
									?>
								</select>
