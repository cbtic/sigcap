...
function fn_save_parentesco(){
    ...
    $.ajax({
            ...
            type: "POST",
            data : {_token:_token,id:id,id_agremiado:id_agremiado,id_parentesco:id_parentesco,id_sexo:id_sexo,apellido_nombre:apellido_nombre,fecha_nacimiento:fecha_nacimiento},
					...
					<div class="row" style="padding-left:10px">
						...
						<div class="col-lg-12">
							<div class="form-group">
								<label class="control-label form-control-sm">Parentesco</label>
								<select name="id_parentesco" id="id_parentesco" class="form-control form-control-sm" onChange="">
									<option value="">--Seleccionar--</option>
									<?php
									foreach ($parentesco as $row) {?>
									<option value="<?php echo $row->codigo?>" <?php if($row->codigo==$agremiadoParenteco->id_parentesco)echo "selected='selected'"?>><?php echo $row->denominacion?></option>
									<?php 
									}
									?>
								</select>
						...
						<div class="col-lg-12">
							<div class="form-group">
								...
								<select name="id_sexo" id="id_sexo" class="form-control form-control-sm" onChange="">
									...
									<?php
									foreach ($sexo as $row) {?>
									<option value="<?php echo $row->codigo?>" <?php if($row->codigo==$agremiadoParenteco->id_sexo)echo "selected='selected'"?>><?php echo $row->denominacion?></option>
									<?php 
									}
									?>
								</select>
						...
						<div class="col-lg-12">
							<div class="form-group">
								<label class="control-label form-control-sm">Nombre y Apellidos</label>
								<input type="text" name="apellido_nombre" id="apellido_nombre"
								value="<?php echo $agremiadoParenteco->apellido_nombre?>" placeholder="" class="form-control form-control-sm col-lg-12" >
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								value="<?php if($agremiadoParenteco->fecha_nacimiento!="")echo date("d-m-Y", strtotime($agremiadoParenteco->fecha_nacimiento))?>" placeholder="" class="form-control form-control-sm col-lg-12" >
							</div>
						</div>
					...
					<div style="margin-top:15px" class="form-group">
						<div class="col-sm-12 controls">
							<div class="btn-group btn-group-sm float-right" role="group" aria-label="Log Viewer Actions">
								<a href="javascript:void(0)" onClick="fn_save_parentesco()" class="btn btn-sm btn-success">Guardar</a>
							</div>
