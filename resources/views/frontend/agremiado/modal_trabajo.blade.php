					...
					<div class="row" style="padding-left:10px">
						...
						<div class="col-lg-12">
							<div class="form-group">
								<label class="control-label form-control-sm">Cargo</label>
								<select name="id_cliente_cargo" id="id_cliente_cargo" class="form-control form-control-sm" onChange="">
									<option value="">--Seleccionar--</option>
									<?php
									foreach ($cargo as $row) {?>
									<option value="<?php echo $row->codigo?>" <?php if($row->codigo==$agremiadoTrabajo->id_cliente_cargo)echo "selected='selected'"?>><?php echo $row->denominacion?></option>
									<?php 
									}
									?>
								</select>
						...
						<div class="col-lg-6">
							<div class="form-group">
								<label class="control-label form-control-sm">Rubro</label>
								<input type="text" name="rubro_negocio" id="rubro_negocio"
								value="<?php echo $agremiadoTrabajo->rubro_negocio?>" placeholder="" class="form-control form-control-sm col-lg-12" >
							</div>
						</div>
						...
						<div class="col-lg-12">
							<div class="form-group">
								...
								<select name="id_departamento_trabajo" id="id_departamento_trabajo" class="form-control form-control-sm" onChange="obtenerProvinciaTrabajo()">
									...
									<option value="<?php echo $row->id_departamento?>" <?php if($row->id_departamento==substr($agremiadoTrabajo->id_ubigeo,0,2))echo "selected='selected'"?>><?php echo $row->desc_ubigeo ?></option>
									<?php 
									}
									?>
								</select>
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								value="<?php echo $agremiadoTrabajo->numero_documento?>" placeholder="" class="form-control form-control-sm col-lg-12" >
							</div>
						</div>
						
						<div class="col-lg-6">
							<div class="form-group">
								<label class="control-label form-control-sm">Centro Trabajo</label>
								<input type="text" name="razon_social" id="razon_social"
								value="<?php echo $agremiadoTrabajo->razon_social?>" placeholder="" class="form-control form-control-sm col-lg-12" >
							</div>
						</div>
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								value="<?php echo $agremiadoTrabajo->direccion?>" placeholder="" class="form-control form-control-sm col-lg-12" >
							</div>
						</div>
						
						<div class="col-lg-6">
							<div class="form-group">
								<label class="control-label form-control-sm">Codigo Postal</label>
								<input type="text" name="codigo_postal" id="codigo_postal"
								value="<?php echo $agremiadoTrabajo->codigo_postal?>" placeholder="" class="form-control form-control-sm col-lg-12" >
							</div>
						</div>
						
						<div class="col-lg-6">
							<div class="form-group">
								<label class="control-label form-control-sm">Referencia</label>
								<input type="text" name="referencia" id="referencia"
								value="<?php echo $agremiadoTrabajo->referencia?>" placeholder="" class="form-control form-control-sm col-lg-12" >
							</div>
						</div>
						
						<div class="col-lg-6">
							<div class="form-group">
								<label class="control-label form-control-sm">Telefono</label>
								<input type="text" name="telefono" id="telefono"
								value="<?php echo $agremiadoTrabajo->telefono?>" placeholder="" class="form-control form-control-sm col-lg-12" >
							</div>
						</div>
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								value="<?php echo $agremiadoTrabajo->celular?>" placeholder="" class="form-control form-control-sm col-lg-12" >
							</div>
						</div>
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								value="<?php echo $agremiadoTrabajo->email?>" placeholder="" class="form-control form-control-sm col-lg-12" >
							</div>
						</div>
					...
					<div style="margin-top:15px" class="form-group">
						<div class="col-sm-12 controls">
							<div class="btn-group btn-group-sm float-right" role="group" aria-label="Log Viewer Actions">
								<a href="javascript:void(0)" onClick="fn_save_trabajo()" class="btn btn-sm btn-success">Guardar</a>
							</div>
