                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div id="" class="row">
                                                    ...
                                                    <table id="tblProductos" class="table table-hover">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="text-right" width="10%">Val.Venta</th>                                                                
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr id="fila{{ $loop->iteration }}">
                                                                ...
                                                                <td class="text-right">{{ number_format($factura_detalle->valor_venta,2) }}
                                                                </td>
                                                                
                                                                <td class="text-right">{{ number_format($factura_detalle->igv_total,2) }}
                                                                </td>
                                                            ...
                                                            <tr id="fila_igv">
                                                                <td class="text-right" colspan="6">IGV(18%) <span class="moneda"><?php echo $modeda?></span> </td>
                                                                <td class="text-right">{{ number_format($factura->impuesto,2) }}</td>
                                                            </tr>
                                                            <tr id="fila_total">
                                                                <td class="text-right" colspan="6">IMPORTE TOTAL <span class="moneda"><?php echo $modeda?></span> </td>
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <td style="text-align: left;"> OPERACIÓN SUJETA A DETRACCIÓN R.S. - 183- 2004/SUNATCta.Para Detacción Banco de la Nación Cta. Cte.M.N. No. 00-000-488801 a nombre del Colegio de Arquitectos del Perú Regional Lima,  Ruc: 20172977911. Porcentaje: 12.0%, Tasa: S/ <span class="resaltado">{{ $factura->total * 12/100 }}</span>                                         
                                            </td>
                                        </tr>
                                        </tbody>
                                        </table>
