    ...
    <div class="justify-content-center">
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0 text-primary">
                        Cuadro de Caja<!--<small class="text-muted">Usuarios activos</small>-->
                    </h4>
                </div><!--col-->
            </div>
        ...
        <div class="col col-sm-12 align-self-center">
            ...
            <div class="card">
				...
				<form class="form-horizontal" method="post" action="{{ route('frontend.comprobante.cierre_caja')}}" id="frmAfiliacion" autocomplete="off">
...
-->
                ...
                <div class="card-body">
                    ...
                    <table id="tblDocumentos" class="table table-hover table-sm">
                        <thead>
...
<script src="{{ asset('js/CierreCaja.js') }}"></script>
@endpush
