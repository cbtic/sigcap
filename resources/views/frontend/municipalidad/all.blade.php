            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0 text-primary">
                        Consultar Municipalidades <!--<small class="text-muted">Usuarios activos</small>-->
                    </h4>
                </div><!--col-->
            </div>
            ...
            <div class="card">
				...
				<div class="row" style="padding:20px 20px 0px 20px;">
					...
					<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12" style="padding-right:0px">
						...
						<a href="/municipalidad" class="btn btn-success pull-rigth" style="margin-left:15px"/>NUEVO</a>
					</div>
				</div>
...
<script src="{{ asset('js/municipalidad.js') }}"></script>
