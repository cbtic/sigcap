                        ...
                        <x-forms.post :action="route('frontend.auth.registerResp')" id="frmUsuario" name="frmUsuario" enctype="multipart/form-data" onsubmit="return validacion(event)">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="id_tipo_documento" id="id_tipo_documento" class="form-control" type="text">
                                ...
                                <div class="col-md-4" id="names_div">
                                    <label id="names-title">Nombres:</label>
                                    <input type="text" name="nombre" class="form-control upper-case just-letters" maxlength="100" required="" id="nombre">
                                    
                                </div>
                                <div class="col-md-4" id="first_surname_div" style="display: block;">
                                    <label>Primer Apellido:</label>
                                    <input type="text" name="apellido_paterno" class="form-control upper-case just-letters" maxlength="50" id="apellido_paterno">
                                    
                                </div>
                                <div class="col-md-4 mt-2" id="second_surname_div" style="display: block;">
                                    <label>Segundo Apellido:</label>
                                    <input type="text" name="apellido_materno" class="form-control upper-case just-letters" maxlength="50" id="apellido_materno">
                                    
                                </div>
                                <div class="col-md-4 mt-2 ">
                                    <label id="identity_title">DNI:</label>
                                    <input type="number" name="numero_documento" class="form-control other-doc-case dni-case" maxlength="15" required="" id="numero_documento">
                                    
                                </div>
                                <div class="col-md-4 mt-2 ">
                                    <label>Correo Electrónico:</label>
                                    <input type="text" name="email" class="form-control" maxlength="50" required="" id="email">
                                    
                                </div>
                                <div class="col-md-4 mt-2">
                                    <label>Teléfono Celular:</label>
                                    <input type="number" name="celular" class="form-control cellphone-case" min="900000000" max="999999999" maxlength="20" required="" id="celular">
