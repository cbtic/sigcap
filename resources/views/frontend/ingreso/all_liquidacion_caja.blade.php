        ...
        <div class="col col-sm-12 align-self-center">
            ...
            <div class="card">
				...
				<div class="row" style="padding:20px 20px 0px 20px;">
					...
					<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
						<div class="form-group">
							<label class="form-control-sm">Fecha Inicio Hasta</label>
							<input class="form-control form-control-sm" id="fecha_inicio_hasta" name="fecha_inicio_hasta" value="" placeholder="Fecha Inicio Hasta">
						</div>
					</div>
					...
					<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
						<div class="form-group">
							<label class="form-control-sm">Fecha Cierre Hasta</label>
							<input class="form-control form-control-sm" id="fecha_fin" name="fecha_fin" value="" placeholder="Fecha Cierre Hasta">
						</div>
					</div>
