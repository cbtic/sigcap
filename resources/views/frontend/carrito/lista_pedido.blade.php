...
?>
	<tr style="font-size:13px" data-toggle="tooltip" data-placement="top">
		...
		<td class="text-left"><?php 
			...
			echo $c[4].$c[5]."/".$c[2].$c[3]."/".$c[0].$c[1]." ".$c[6].$c[7].":".$c[8].$c[9].":".$c[10].$c[11]; 
		?></td>
		<td class="text-left"><?php echo $row->email ?></td>
		<td class="text-left"><?php echo $data->dataMap->CARD." (".$data->dataMap->BRAND.")"; ?></td>
		<td class="text-left"><?php echo $data->order->amount. " ".$data->order->currency; ?></td>
		<td>
