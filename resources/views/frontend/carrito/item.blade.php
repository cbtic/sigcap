	...
	<section class="seccion-principal seccion-formularios">
		...
		<div class="card">
			<div class="card-body">
				...
				<input type="hidden" name="tasa.codTasa" value="00521">
				<input type="hidden" name="servicio.codigo" value="">
				<input type="hidden" name="servicio.input" value="">
				<input class="form2" type="hidden" name="operacion.id" value="162">
				<input class="form2" type="hidden" name="operacion.idTxn" value="3">
				<input class="form2" type="hidden" name="operacion.idItemCarrito" value="0">
				<input class="form2" type="hidden" name="operacion.action" value="">
