...
<script>
	...
	<section class="seccion-sidebar" style="visibility: visible;">
		<div class="card" style="position: absolute; top: 173.203px;">
			...
			<div class="card-body">
				<h6 class="subtitulo">¿Cómo descargo mi constancia?</h6>
				<p>Puedes descargar todas las constancias de pago, ingresando a la opción "Ver".</p>
				<p>Si tu ticket aún está pendiente de pago, puedes continuar con el proceso haciendo clic sobre el botón "Pagar".</p>
				<p>Recuerda, solo se muestran en este listado los tickets de pago generados en los últimos 30 días.</p>
				<!-- dinamico -->
				<h6 class="subtitulo">¿Por qué mi ticket está pendiente y no puedo pagarlo?</h6>
				<p>Debido a que el concepto seleccionado es un servicio y no podrá pagarlo por esta opción, deberás generar un nuevo ticket de pago.</p>
			</div>
		</div>
	</section>
</div>
