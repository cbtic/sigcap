...
function fn_save(){
    ...
    $.ajax({
            ...
            type: "POST",
            data : {_token:_token,id:id,id_regional:id_regional,id_plan:id_plan,id_agremiado:id_agremiado,fecha:fecha,observaciones:observaciones},
			//dataType: 'json',
						...
						<div class="card-body" style="margin-top:1px;margin-bottom:1px">
							<div class="row">	
									...
									<div class="col-lg-2 col-md-12 col-sm-12 col-xs-12">
										...
										<input id="situacion_" name="situacion_" class="form-control form-control-sm"  value="<?php echo $situacion?>" type="text"  >
									</div>
						...
						<div class="card-body" style="margin-top:15px;margin-bottom:15px">
											...
											<div class="row">
												<div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
													<label class="control-label">Segutr</label>
