...
Route::get('sesion/importar_dataLicencia_dictamenes/{fecha_ejecucion}/{id_comision}', [SesionController::class, 'importar_dataLicencia_dictamenes'])->name('sesion.importar_dataLicencia_dictamenes');
