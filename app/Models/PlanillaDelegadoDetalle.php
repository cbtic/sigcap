...
class PlanillaDelegadoDetalle extends Model
{
    ...
    function getDatosRecibo($id){     
        ...
        $cad = "select pdd.id, a.numero_cap, p.apellido_paterno ||' '|| p.apellido_materno ||' '|| p.nombres agremiado, pdd.numero_comprobante, pdd.fecha_comprobante, pdd.numero_operacion from planilla_delegado_detalles pdd 
