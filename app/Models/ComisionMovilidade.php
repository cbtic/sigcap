...
class ComisionMovilidade extends Model
{
	...
	function getMovilidadByPeriodo($id_periodo,$anio,$mes){

        $cad = "select cm.id,mi.id, mi.denominacion comision, pc.descripcion periodo, r.denominacion regional, cm.monto, tm.denominacion, cm.estado 
