...
class DerechoRevision extends Model
{
	...
	function getCodigoSolicitud($id_tipo_solicitud){
        ...
        $cad = "select lpad(max(numero_revision)::varchar,7,'0') codigo from solicitudes s where id_tipo_solicitud=123 and estado ='1'";
        //echo $cad;exit();
		$data = DB::select($cad);
...
m.denominacion municipalidad, a.numero_cap, a.desc_cliente, s.fecha_registro, s.estado, 
CASE 
