...
class Certificado extends Model
{
    ...
    public function datos_agremiado_certificado($id){
        ...
        inner join tabla_maestras tm2 on c.id_tipo_tramite= tm2.codigo::int and  tm2.tipo ='44' 
        where c.id=". $id .";  ";
    ...
    public function datos_agremiado_certificado1($id){
        ...
        inner join propietarios prop on prop.id_solicitud = s.id 
        inner join personas p2 on prop.id_persona = p2.id
        inner join presupuestos pre on pre.id_solicitud = s.id 
        inner join uso_edificaciones ue on ue.id_solicitud = s.id
        ...
        inner join tabla_maestras t6 on ue.id_tipo_uso = t6.codigo::int And t6.tipo ='30' 
        inner join tabla_maestras t7 on ue.id_sub_tipo_uso = t7.codigo::int And t7.tipo ='111' and t7.sub_codigo ='1'
        where c.id='". $id ."'";
