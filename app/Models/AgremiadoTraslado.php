...
class AgremiadoTraslado extends Model
{
	...
	function getAgremiadoTraslado($id_agremiado){
        ...
        $cad = "select at2.id,r.denominacion region,at2.numero_regional,to_char(at2.fecha_inicio,'dd-mm-yyyy')fecha_inicio,to_char(at2.fecha_inicio,'dd-mm-yyyy')fecha_fin,at2.observacion  
