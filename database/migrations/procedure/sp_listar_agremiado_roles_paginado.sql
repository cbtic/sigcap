...
begin
	...
	v_campos=' distinct ar.id, a.numero_cap, p.apellido_paterno ||'' ''|| p.apellido_materno ||'' ''|| p.nombres agremiado, tm.denominacion rol, tm2.denominacion rol_especifico , ar.fecha_inicio, ar.fecha_fin, ar.observacion, ar.estado ';
