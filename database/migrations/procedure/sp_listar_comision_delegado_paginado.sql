CREATE OR REPLACE FUNCTION public.sp_listar_comision_delegado_paginado(p_id_periodo_comisiones character varying, p_id_tipo_agrupacion character varying, p_tipo_comision character varying, p_comision character varying, p_estado character varying, p_pagina character varying, p_limit character varying, p_ref refcursor)
 RETURNS refcursor
 LANGUAGE plpgsql
AS $function$
