CREATE OR REPLACE FUNCTION public.sp_listar_concepto_paginado(p_regional character varying, p_codigo character varying, p_denominacion character varying, p_partida_presupuestal character varying, p_estado character varying, p_pagina character varying, p_limit character varying, p_ref refcursor)
 RETURNS refcursor
 LANGUAGE plpgsql
AS $function$
...
Begin
	...
	v_campos=' c.id, r.denominacion regional, c.codigo, c.denominacion , c.id_partida_presupuestal partida_presupuestal, c.estado ';
