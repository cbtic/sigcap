...
begin
	...
	v_campos=' p.id, p.anio, p.porcentaje_calculo_edificacion, p.valor_minimo_edificaciones, p.valor_maximo_edificaciones, p.valor_metro_cuadrado_habilitacion_urbana, p.valor_minimo_hu, p.valor_maximo_hu, p.valor_uit, p.igv, p.estado ';
