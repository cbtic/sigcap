...
class AddItemsToComisionSesionDictamenes extends Migration
{
    ...
    public function up()
    {
        Schema::table('comision_sesion_dictamenes', function (Blueprint $table) {
            ...
            $table->varchar('numero_expediente',100)->nullable();
            ...
            $table->varchar('opinion_presidente',1)->nullable();
            $table->varchar('opinion_presidente_desc',5000)->nullable();
            $table->varchar('opinion_delegado',1)->nullable();
            $table->Integer('id_opinion_delegado')->nullable();
            $table->Integer('id_instancia')->nullable();
            $table->varchar('opinion_delegado_desc',5000)->nullable();
            $table->varchar('notas_adicionales',5000)->nullable();
